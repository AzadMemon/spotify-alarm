...
public class Alarm extends AppCompatActivity implements SpotifyPlayer.NotificationCallback, ConnectionStateCallback {
            ...
            if (response.getType() == AuthenticationResponse.Type.TOKEN) {
                ...
                Spotify.getPlayer(playerConfig, this, new SpotifyPlayer.InitializationObserver() {
                    ...
                    public void onInitialized(SpotifyPlayer spotifyPlayer) {
                        ...
                        mPlayer.addConnectionStateCallback(Alarm.this);
                        mPlayer.addNotificationCallback(Alarm.this);
                    }
